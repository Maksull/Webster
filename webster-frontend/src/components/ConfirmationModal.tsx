            ...
            <div className="relative z-50 bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
                ...
                <div className="flex justify-end space-x-3 p-6 pt-0">
                    ...
                    <button
                        ...
                        onClick={onConfirm}
                        disabled={isLoading}
                        className={`cursor-pointer px-4 py-2 text-sm font-medium text-white rounded-lg focus:ring-2 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center ${typeStyles.confirmButton}`}>
                        {isLoading ? (
                            <>
                                <svg
